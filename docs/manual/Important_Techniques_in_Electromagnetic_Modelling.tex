...
\begin{figure}
  \centering
  \subcaptionbox{
    Geometry\label{fig:Laminated-Block-Flux-Parallel-Geometry}}{
    \includeinkscape{Laminated-Block-Flux-parallel-axonometric}
  }
  \hfil
  \subcaptionbox{
    equivalent magnetic circuit\label{fig:Laminated-Block-Flux-Parallel-Circuit}}{
    \includeinkscape{Laminated-Block-Flux-parallel-equiv-circ}
  }
...
\begin{figure}
  \centering
  \subcaptionbox{Geometry}{
    \includeinkscape{Laminated-Block-Flux-perpendicular-axonometric}}
  \hfil
  \subcaptionbox{equivalent magnetic circuit}{
    \includeinkscape{Laminated-Block-Flux-perpendicular-equiv-circ}
  }
...
\begin{figure}
  \centering
  \includeinkscape{Laminated-Block-Toroidal}
...
\begin{figure}
  ...
  \subcaptionbox{excitation by a sinusoidal current}{
    \begin{tikzpicture}
      \begin{axis}[
        height=.44\textheight,
        ...
        ylabel=$H\cdot\unit{\metre\per\kilo\ampere}$,
        zlabel=$B/\unit{\tesla}$,
        line width=.35mm]
        \addplot3[mark=none,line width=.7mm,style=dotted]
          table [x index=0,y index=1,z index=2,header=false] {M330-35-A.csv};
        ...
        \addplot3[mark=none,line width=.7mm,style=loosely dashdotted]
          table [x index=0,y index=1,z index=2,header=false] {M330-35-A_H-Ampl-160.csv};
        \addplot3[mark=none,line width=.7mm,style=densely dashdotted]
          table [x index=0,y index=1,z index=2,header=false] {M330-35-A_H-Ampl-2800.csv};
      \end{axis}
    \end{tikzpicture}
  }\\ \bigskip
  \subcaptionbox{excitation by a sinusoidal voltage}{
    \begin{tikzpicture}
      \begin{axis}[
        height=.44\textheight,
        ...
        \addplot3[mark=none,line width=.7mm,style=dotted] 
          table [x index=0,y index=1,z index=2,header=false] {M330-35-A.csv};
        \addplot3[mark=none,line width=.7mm,style=loosely dashdotted]
          table [x index=0,y index=1,z index=2,header=false] {M330-35-A_B-Ampl-0.6.csv};
        \addplot3[mark=none,line width=.7mm,style=densely dashdotted]
          table [x index=0,y index=1,z index=2,header=false] {M330-35-A_B-Ampl-1.6.csv};
        \addplot3[mark=none,line width=.7mm,style=loosely dashdotted]
          ({y/pi}, {0}, {.6*sin(deg(y))});
        \addplot3[mark=none,line width=.7mm,style=densely dashdotted]
...
\begin{figure}
  \centering
  \sisetup{per-mode=fraction}
  \subcaptionbox{transformed curve for current input}{
    \begin{tikzpicture}
      \begin{semilogxaxis}[
        height=.42\textheight,
        width=.6795742752749558\textheight,
        xlabel=$H\cdot\unit{\metre\per\kilo\ampere}\quad\longrightarrow$,
        ...
        \addplot[mark=none,line width=.7mm,style=dotted]
          table [x index=0,y index=1,header=false] {M330-35-A_xy.csv};
        \addplot[mark=none,line width=.7mm,style=loosely dashed]
          table [x index=0,y index=1,header=false] {M330-35-A_current-input.csv};
        \legend{orig. curve, transformed}
      \end{semilogxaxis}
    \end{tikzpicture}
  }\\[1.4\bigskipamount]
  \subcaptionbox{transformed curve for voltage input}{
    \begin{tikzpicture}
      \begin{semilogxaxis}[
        height=.42\textheight,
        width=.6795742752749558\textheight,
        ...
        \addplot[mark=none,line width=.7mm,style=dotted]
          table [x index=0,y index=1,header=false] {M330-35-A_xy.csv};
        \addplot[mark=none,line width=.7mm,style=loosely dashed]
          table [x index=0,y index=1,header=false] {M330-35-A_voltage-input.csv};
        \legend{orig. curve, transformed}
      \end{semilogxaxis}
    \end{tikzpicture}
  }
