...
\begin{figure}
  \centering
  \subfloat[average iron path]{
    \input{../images/Compute-with-av-path.pdf_tex}
    \label{fig:descret-meth-1}
  }\newline \vfil
  \subfloat[typical FEM-mesh]{
    \input{../images/Compute-with-fem.pdf_tex}
    \label{fig:descret-meth-2}
  }\newline \vfil
  \subfloat[FIT grid]{
    \input{../images/Compute-with-fit.pdf_tex}
    \label{fig:descret-meth-3}
  }
